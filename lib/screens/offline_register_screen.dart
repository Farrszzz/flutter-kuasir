...
class OfflineRegisterScreen extends StatefulWidget {
  const OfflineRegisterScreen({super.key});

  @override
  State<OfflineRegisterScreen> createState() => _OfflineRegisterScreenState();
}

class _OfflineRegisterScreenState extends State<OfflineRegisterScreen> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Daftar untuk menggunakan Kuasir Offline',
