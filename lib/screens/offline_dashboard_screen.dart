...
import 'package:kuasir/screens/offline_barang_screen.dart';
import 'package:kuasir/screens/offline_transaksi_screen.dart';
import 'package:kuasir/screens/offline_history_screen.dart';
...
class _OfflineDashboardScreenState extends State<OfflineDashboardScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (authProvider.user != null) {
        Provider.of<OfflineTransaksiProvider>(context, listen: false)
            .loadTransaksi(authProvider.user!['id']);
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    final List<Widget> screens = [
      _buildDashboardHome(),
      const OfflineBarangScreen(),
      const OfflineTransaksiScreen(),
      const OfflineHistoryScreen(),
    ];
  ...
  Widget _buildDashboardHome() {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kuasir Offline'),
                  ...
                  if (value == 'logout') {
                    ...
                    if (mounted) {
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
                          builder: (context) => const OfflineLoginScreen(),
                        ),
                      );
                    }
                  }
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          final authProvider = Provider.of<OfflineAuthProvider>(context, listen: false);
          if (authProvider.user != null) {
            await Provider.of<OfflineTransaksiProvider>(context, listen: false)
                .loadTransaksi(authProvider.user!['id']);
          }
        },
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Row(
                        children: [
                          Expanded(
                            child: Text(
                              'Selamat Datang di Kuasir Offline',
                      ...
                      Text(
                        'Sistem kasir yang bekerja tanpa internet',
              ...
              Consumer<OfflineTransaksiProvider>(
